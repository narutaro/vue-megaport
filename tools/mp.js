var XMLHttpRequest = require("xmlhttprequest").XMLHttpRequest; // added for node.js command line execution @narutaro
  ...
  var exports = function (baseurl) {
    ...
    this.product = function (productId) {
      ...
      return {
        ...
        google: function (pairingKey) {
          var innerThis = this;
          return new Promise(function (resolve, reject) {
            q.onready(function () {
              xhr.get(baseurl + '/secure/google/' + pairingKey, {}, innerthis.credentials.token)
                .then(
                  function (d) {
                    resolve(d.data || d);
                  }
        ...
        azurePeeringDetails: function () {
          return new Promise(function (resolve, reject) {
            q.onready(function () {
              xhr.get(baseurl + '/secure/azure/' + productId + '/peeringdetails', {}, innerthis.credentials.token)
                .then(
                  function (d) {
                    resolve(d.data || d);
                  }
